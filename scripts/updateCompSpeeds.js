...
const allTokens = [
    ...
    '0x8C86799D402CD6D5d05FBb271f5f421f277C230d',
    '0x5264A0AdF29E31C618273a0260E9de8Edc13811F', //(F)
    '0x3D7a2A68D00F117e9c3cFCfA9c1c1f73cB52baFc'
]

const allCompSpeeds = [
    '312000000000000000', // HT
    '1950000000000000', // ELA
    '175500000000000000', // HFIL
    '0',                  // ethUSDT
    '998400000000000000', // HUSD
    '0',                  // HPT(F)
    '0',                  // ETH(F
    '0',                  // HBTC
    '1950000000000000', // HPT
    '70200000000000000', // ETH
    '136500000000000000', // HBTC
    '0',                  // HDOT(F)
    '23400000000000000', // HDOT
    '5850000000000000', // HBCH
    '0',                  // HLTC(F)
    '5850000000000000', // HLTC
    '2070900000000000000', // HUSDT
    '0',                 // HBSV(F)
    '0', // HBSV
    '0',                  // HXTZ(F)
    '0',   // HXTZ
    '0',    // PNEO
    '3900000000000000', // AAVE
    '3900000000000000', // UNI
    '0', // SNX
    '81900000000000000',  // MDX
    '0',  // Link
    '0',
    '0',
    '0',
