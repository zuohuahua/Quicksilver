...
module.exports = async function(deployer, network) {
    ...
    await deployer.deploy(sELA, Unitroller.address, InterestModel.address, "10000000000000000000", "QuickSilver ELA", "sELA", 18, admin);
    ...
    await proxiedComptrollerContract.methods._setLiquidationIncentive(1.5e18.toString()).send({from: admin, gas: 3000000});
    ...
    await proxiedComptrollerContract.methods._setCompRate(0.5e18.toString()).send({from: admin, gas: 3000000});
